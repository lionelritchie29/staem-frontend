...
import { getProfileBgUrl, getUserImageUrl } from 'src/app/globals';
...
export class ProfileComponent implements OnInit {
  ...
  getUser(customUrl: string): void {
    this.getUserByUrlGqlService
      ...
      .valueChanges.subscribe((res) => {
        ...
        this.profileImgUrl = getUserImageUrl(
          this.currentUser.profile.profilePictureUrl
        );
        this.backgroundImageUrl = getProfileBgUrl(
          this.currentUser.profile.profileBackgroundUrl
        );
        this.getFriends();
        this.getGames();
        this.getComments();
      ...
      .valueChanges.subscribe((res) => {
        ...
        if (this.loggedUser != null) {
          const filtered = this.friends.filter(
            (friend) => friend.id === this.loggedUser.id
          );
  ...
  onReport() {
    ...
    this.createUserReportGqlService
      .mutate({
